...
\]
The link between the solutions of the ILP problem \eqref{eq:ilp_without_nproj} and
...
\end{lemma}
\begin{proof}
  Suppose there exists a non-feasible solution \( x \) that corresponds to a feasible
  solution of the MaxWIS problem. Then, we have:
  \[
...
independent set problem. Consequently, it can be solved using a polynomial-time
algorithm.
\begin{theorem}
