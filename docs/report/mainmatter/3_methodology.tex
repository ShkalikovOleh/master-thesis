...
\begin{proof}
    ...
    \begin{align*}
        ...
        \sum\limits_{\tgt{p} \in T} x_{\src{p}, \tgt{p}} > n_{proj} \qquad
    \end{align*}
    ...
    same equivalence class, therefore the MaxIS problem can be solved as an instance of the problem \eqref{eq:objective}--\eqref{eq:binary_prog}
